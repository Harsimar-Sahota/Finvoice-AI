    ...
    <section className="max-w-4xl mx-auto px-6 py-16">
      <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
        ...
        <p className="text-slate-600 mb-4">
          Finvoice AI is provided for learning and demonstration purposes only. It is not a commercial product — there are no payments or subscriptions.
        </p>
        ...
        <div className="flex gap-3">
          <Link to="/contact" className="px-5 py-3 bg-blue-900 text-white rounded-lg">Contact about terms</Link>
