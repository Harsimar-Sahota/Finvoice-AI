  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
        <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">About Finvoice AI</h1>
        <p className="text-slate-600 leading-relaxed mb-6">
          Finvoice AI was built by <strong>Harsimarpreet Singh Sahota</strong> to make invoice management simple and smart using modern AI.
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="p-4 bg-gradient-to-tr from-blue-50 to-white rounded-lg border">
            <h4 className="font-semibold text-slate-900">Why Finvoice AI?</h4>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <Link to="/dashboard" className="px-6 py-3 bg-gradient-to-r from-blue-900 to-blue-700 text-white rounded-xl font-semibold shadow hover:scale-[1.01] transition transform">
            Try Dashboard
          </Link>

          <a href="https://github.com/your-repo" target="_blank" rel="noopener noreferrer" className="px-6 py-3 border border-slate-200 rounded-xl text-slate-900 hover:bg-slate-50 transition">
            View Code on GitHub
          </a>
